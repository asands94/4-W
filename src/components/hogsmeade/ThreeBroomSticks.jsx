...
export default function ThreeBroomSticks() {
  ...
  // function shuffle() {
  //   // e.preventDefault()
  //   const randomMealNum = meals[Math.floor(Math.random() * num)]
  //   if (randomMealNum === meals.length) {
  //     setShuffled(randomMealNum)
  //   } else {
  //     setShuffled(Math.floor(Math.random() * num))
  //   }
  // }
